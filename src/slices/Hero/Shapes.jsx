...
function Geometries() {
    const geometries = [
        ...
        },
        {
            position: [-1.4, 2, -4],
            r: 0.6,
            geometry: new THREE.DodecahedronGeometry(1.5,) //sphere
        },
        {
            position: [-0.8, -0.75, 5],
            r: 0.5,
    ...
    const materials = [
        ...
        new THREE.MeshStandardMaterial({color: 0x6D214F, roughness: 0.4}),
        new THREE.MeshStandardMaterial({color: 0x34495e, roughness: 0.1}),
        new THREE.MeshStandardMaterial({color: 0xe67e22, roughness: 0.1}),
        new THREE.MeshStandardMaterial({color: 0x4834d4, roughness: 0.1}),
